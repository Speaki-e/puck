...
final class BridgeServerTests: XCTestCase {
    ...
    // ShaydiAgent, so bridge.sock now has two roles connected at once and
    ...
    /// The quick-capture bubble's text is mirrored to ShaydiAgent with
    ...
    /// nowhere to go yet, once ShaydiAgent (which it launched a moment
