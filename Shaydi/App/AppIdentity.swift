...
//  PRODUCT_BUNDLE_IDENTIFIER for the Shaydi/ShaydiAgent targets --
...
enum AppIdentity {
    /// Must match project.yml's Shaydi target PRODUCT_BUNDLE_IDENTIFIER.
    static let shaydiBundleID = "com.speaki-e.Shaydi"
    /// Must match project.yml's ShaydiAgent target PRODUCT_BUNDLE_IDENTIFIER.
    static let shaydiAgentBundleID = "com.speaki-e.ShaydiAgent"
    ...
    static let applicationSupportDirectoryName = "Shaydi"

    /// User-facing name for the pet app.
    static let displayName = "Shaydi"
    /// User-facing name for the chat/agent client app.
    static let clientDisplayName = "ShaydiAgent"
}
