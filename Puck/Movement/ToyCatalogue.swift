...
//  mirroring how avatar packages are laid out -- byeolki added a second one
//  ("지팡이도 새로 추가함 / 장난감 에셋 정리하는 폴더도 만들어서 각각
//  정리해줘", 2026-07-29) and a flat pile of PNGs stops telling you what
...
/// catching, a wand is for twirling (byeolki: "지팡이는 펫 머리 위에서
/// 회전되게", 2026-07-29) -- and which one it is belongs to the toy rather
