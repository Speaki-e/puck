...
enum L10nKey: String, CaseIterable, Hashable {
    ...
    /// F13 (2026-07-30): ShaydiAgent is a separate Dock-resident app now
...
enum Strings {
    ...
    private static let table: [L10nKey: [AppLanguage: String]] = [
        ...
        .menuQuit: [.english: "Quit Shaydi", .korean: "Shaydi 종료"],
        .menuOpenClient: [.english: "Open Shaydi Chat", .korean: "Shaydi 채팅 열기"],
    ]
}
