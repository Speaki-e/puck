...
final class TextInputBubbleWindow: NSWindow, NSWindowDelegate {
    ...
    /// Shaydi -- closeAndRestoreFocus() would then "restore" focus to
    /// Shaydi instead of the app the user actually invoked this from.
    func showAndActivate() {
        ...
        // Shaydi is LSUIElement/.accessory, and a background app's window
    ...
    /// key and never activates Shaydi.
    ///
    ...
    func showSpeech() {
        alphaValue = 0
        // Regardless: Shaydi is .accessory and usually not the active app,
    ...
    /// is about to go to ShaydiAgent's window instead of back to the app
