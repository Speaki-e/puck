...
//  The agent's OpenAI API key, moved here from Puck's own SettingsView --
//  byeolki, 2026-08-02: "기존 셰이디앱에 있던 에이전트 관련 설정은 전부
//  셰이디에이전트 설정으로 옮기고". The agent that actually reads the key
//  (AgentHost, in this process) runs here, not in Puck -- Puck's panel
//  only ever showed this field because PuckClient had no Settings surface
